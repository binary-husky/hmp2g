...
def BayesianOptimisation(nth_trial, mcv, args, MasterAutoRLKey, HmpBayesianOptimizationInterface):
    ...
    f = HmpBayesianOptimizationInterface(MasterAutoRLKey=MasterAutoRLKey)
