...
MasterAutoRLKey = 'auto_rl_test_ratio'
        ...
        return """
{
    "config.py->GlobalConfig": {
        ...
        "backup_files": [
            "ALGORITHM/experimental_conc_mt_fuzzy_agent_wise_tr",
    ...
    "MISSION.dca_multiteam.collective_assult_parallel_run.py->ScenarioConfig": {
        ...
        "TEAM_NAMES": [
            ...
            "ALGORITHM.experimental_conc_mt_fuzzy_agent_wise_tr.foundation->ReinforceAlgorithmFoundation",
            "TEMP.TEAM2.ALGORITHM.experimental_conc_mt_fuzzy_agent_wise_tr.foundation->ReinforceAlgorithmFoundation",
        ]
    },

    "ALGORITHM.experimental_conc_mt_fuzzy_agent_wise_tr.foundation.py->AlgorithmConfig": {
        ...
        "fuzzy_controller_param": [ 1,2,3 ],
        "fuzzy_controller_scale_param": [-99],
        "gpu_party_override": "cuda6_party0"
    },

    "TEMP.TEAM2.ALGORITHM.experimental_conc_mt_fuzzy_agent_wise_tr.foundation.py->AlgorithmConfig": {
        "train_traj_needed": 32,
        "n_focus_on": 3,
        "lr": 0.0003,
        "ppo_epoch": 16,
...
"""
    ...
    def prev_part(self, X, batch):
        ...
        self.logger.info(f'input X={X} | parsed {[p0,p1,p2]}')

        conf_override.update({
                "ALGORITHM.experimental_conc_mt_fuzzy_agent_wise_tr.foundation.py->AlgorithmConfig-->fuzzy_controller_param": \
                    [[p0,p1,p2]] * self.n_run
            })
    ...
    def get_device_conf(self, batch):
        if batch==0:
            return {
                ########################################
                "ALGORITHM.experimental_conc_mt_fuzzy_agent_wise_tr.foundation.py->AlgorithmConfig-->device_override":
                    [
                        "cuda:0",
                        "cuda:0",
                        "cuda:1",
                ...
                "ALGORITHM.experimental_conc_mt_fuzzy_agent_wise_tr.foundation.py->AlgorithmConfig-->gpu_party_override":
                    [
                        "#0",
                        "#0",
                        "#0",
                ...
                ########################################
                "TEMP.TEAM2.ALGORITHM.experimental_conc_mt_fuzzy_agent_wise_tr.foundation.py->AlgorithmConfig-->device_override":
                    [
                        "cuda:0",
                        "cuda:0",
                        "cuda:1",
                ...
                "TEMP.TEAM2.ALGORITHM.experimental_conc_mt_fuzzy_agent_wise_tr.foundation.py->AlgorithmConfig-->gpu_party_override":
                    [
                        "#1",
                        "#1",
                        "#1",
