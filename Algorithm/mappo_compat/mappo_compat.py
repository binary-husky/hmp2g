...
class MappoFoundation():
    def init_pymarl(self):
        ...
        subprocess.Popen(["python", 
            "/home/hmp/mappo/mappo/train_smac.py", 
            "--env_name", "StarCraft2",
            "--algorithm_name", "mappo",
            "--experiment_name", "mlp",
            "--map_name", "corridor",
            "--seed", str(GlobalConfig.seed),
            "--n_training_threads", str(AlgorithmConfig.n_training_threads),
            "--n_rollout_threads", str(self.n_thread), # "8",
            "--num_mini_batch", "1",
            "--episode_length", "400",
    ...
    def __del__(self):
        print('MappoFoundation end, cleaning')
