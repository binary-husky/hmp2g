...
MasterAutoRLKey = 'auto_rl_fuzzy_agentwise_weighting_01t05'
...
"""
    ...
    def prev_part(self, X, batch):
        ...
        p6 = self.convert_continuous( from_x = X[5], to_range=[0.1,      0.5], p_index=5)


        conf_override.update({
                "ALGORITHM.experimental_conc_mt_fuzzy_agent_wise.foundation.py->AlgorithmConfig-->fuzzy_controller_param": [
                    [p1,p2,p3,p4,p5],
                    [p1,p2,p3,p4,p5],
                    [p1,p2,p3,p4,p5],
                    [p1,p2,p3,p4,p5],
        ...
        conf_override.update({
                "ALGORITHM.experimental_conc_mt_fuzzy_agent_wise.foundation.py->AlgorithmConfig-->fuzzy_controller_scale_param": [
                    [p6],
                    [p6],
                    [p6],
                    [p6],
