...
class PPO():
    ...
    def train_on_traj(self, traj_pool, task):
        ...
        for e in range(self.ppo_epoch):
            ...
            for small_batch in range(n_batch):
                ...
                loss_final = 0
                policy_loss, entropy_loss, gx_value_loss, loss_final_t = self.get_loss(sample)
    ...
    def get_loss(self, sample):
        ...
        loss_final = policy_loss   +value_loss*self.value_loss_coef   -entropy_loss*self.entropy_coef
        return policy_loss, entropy_loss, value_loss, loss_final
