...
class PPO():
    ...
    def fuzzy_adjustment(self, wr, pool):
        ...
        # test_ratio = np.array([feedback_sys_agent_wise.compute_fn(a) for a in normalized_score])

        GlobalConfig.test_ratio = feedback_sys.compute_fn((wr,))
        # GlobalConfig.test_ratio_controller = feedback_sys_agent_wise
