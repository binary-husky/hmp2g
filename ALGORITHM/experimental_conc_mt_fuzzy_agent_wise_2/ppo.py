...
class PPO():
    ...
    def traj_agentwise(self, pool, fuzzy_controller_param, scale_param):
        ...
        def fuzzy_compute(feedback_sys, agent_life_std):
            ...
            _log_multiplier = feedback_sys.output['_log_multiplier']
            _multiplier = 10 ** _log_multiplier
            return _multiplier
        ...
        feedback_sys_agent_wise = gen_feedback_sys_generic(
            ...
            antecedent_min=-1.0,
            antecedent_max=+1.0,
            consequent_key='_log_multiplier',
        ...
        _multiplier = np.array([feedback_sys_agent_wise.compute_fn(a) for a in clamp_score_1])
        self.agent_adjust_factor_flat = _multiplier
