...
from MISSION.starcraft.smac.env.multiagentenv import MultiAgentEnv
from MISSION.starcraft.smac.env.starcraft2.maps import get_map_params
...
class StarCraft2Env(MultiAgentEnv):
    ...
    def __init__(
        ...
        reward_vec=False,
        fix_shield_reward_bug=True, # A notorious bug reported at https://github.com/oxwhirl/smac/issues/72
        fix_shield_reward_bug_removeabs=True, # A notorious bug reported at https://github.com/oxwhirl/smac/issues/72
        return_mat=False,
        replay_dir="",
        replay_prefix="",
        window_size_x=1920,
        ...
        self.fix_shield_reward_bug = fix_shield_reward_bug # A notorious bug reported at https://github.com/oxwhirl/smac/issues/72
        self.fix_shield_reward_bug_removeabs = fix_shield_reward_bug_removeabs
    ...
    def step(self, actions):
        ...
        terminated = False
        reward = self.reward_battle()   # <1>计算稠密奖励，但如果self.reward_sparse，这个reward根本不用
        ...
        if game_end_code is not None:
            ...
            if game_end_code == 1 and not self.win_counted:
                ...
                if not self.reward_sparse:
                    reward += self.reward_win  # <2> 胜利的额外奖励
                else:
                    reward = 1
    ...
    def reward_battle(self):
        ...
        # print([e_unit.health for e_id, e_unit in self.enemies.items()]) # REMOVE
        # print([e_unit.shield for e_id, e_unit in self.enemies.items()]) # REMOVE
        # print(reward) # REMOVE
        return reward
    ...
    def render_original(self, mode="human"):
        if self.renderer is None:
            from MISSION.starcraft.smac.env.starcraft2.render import StarCraft2Renderer
